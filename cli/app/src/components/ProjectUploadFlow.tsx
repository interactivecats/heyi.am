...
import { WorkTimeline, GrowthChart, DirectoryHeatmap } from '@heyiam/ui';
import {
  fetchSessions,
  fetchSession,
...
// GrowthChart and DirectoryHeatmap moved to @heyiam/ui — re-export for existing test imports
export { GrowthChart, DirectoryHeatmap, buildGrowthTimeSeries, buildSmoothPath, formatLocAxis, formatLocDelta, computeAxisTicks } from '@heyiam/ui';
export type { GrowthPoint, SessionBoundary } from '@heyiam/ui';
//  GrowthChart component, DirectoryHeatmap component + all helpers)
  ...
  return (
    <div className="project-preview" role="dialog" aria-label="Project preview">
      ...
      <div className="project-preview__content">
        ...
        <WorkTimeline sessions={allSessions} onSessionClick={setDetailSession} maxHeight={300} />

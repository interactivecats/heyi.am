...
describe('enhanceProject', () => {
  it('calls Anthropic with correct model and returns parsed result', async () => {
    mockResponse(VALID_ENHANCE_RESULT);
  ...
  it('throws on invalid JSON response', async () => {
    mockResponseText('I cannot generate a project narrative.');
  ...
  it('throws on incomplete result (missing narrative)', async () => {
    mockResponse({ arc: [], skills: [], timeline: [], questions: [] });

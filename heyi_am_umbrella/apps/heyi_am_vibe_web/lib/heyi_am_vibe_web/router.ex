  ...
  pipeline :browser do
    ...
    plug :put_secure_browser_headers, %{
      "content-security-policy" =>
        "default-src 'self'; script-src 'self' https://analytics.interactivecats.com https://static.cloudflareinsights.com; connect-src 'self' https://analytics.interactivecats.com https://cloudflareinsights.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src https://fonts.gstatic.com; img-src 'self' data:; frame-ancestors 'none'"
    }
  end

defmodule HeyiAmAppWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use HeyiAmAppWeb.ConnCase, async: true`, although
  ...
  def register_and_log_in_user(%{conn: conn} = context) do
    ...
    scope = HeyiAm.Accounts.Scope.for_user(user)
  ...
  defp maybe_set_token_authenticated_at(token, authenticated_at) do
    HeyiAm.AccountsFixtures.override_token_authenticated_at(token, authenticated_at)
  end

  @doc """
  Creates an API conn with a valid Bearer token for the given user.
  Returns {conn, user} with user auto-created if nil.
  """

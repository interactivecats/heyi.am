...
# Allow DATABASE_URL to override dev.exs database config in any env
...
# MinIO / S3 storage (works in all envs, overridable via env vars)
if System.get_env("S3_ENDPOINT") do
  s3_uri = URI.parse(System.get_env("S3_ENDPOINT"))

  config :heyi_am, :storage,
    bucket: System.get_env("S3_BUCKET", "heyi-public"),
    public_base_url: System.get_env("STORAGE_PUBLIC_URL", "http://localhost:9000/heyi-public")
